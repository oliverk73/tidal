#!/usr/bin/env python3
"""
UTide harmonic analysis for Philippine tide stations using UHSLC hourly data.
...
CSV_DIR = Path("/home/oliver/water_levels/Philippines_UHSLC")
TEMPLATE_PATH = Path("/home/oliver/harmonics/classic/harmonics-dwf-20070318_mod.txt")
OUTPUT_PATH = Path("/home/oliver/harmonics/utide/harmonics_utide_philippines.txt")
CHECKPOINT_DIR = Path("/home/oliver/harmonics/utide/checkpoints_philippines")

USE_LAST_N_YEARS = 19

STATIONS = {
    370: {'name': 'Manila', 'lat': 14.585, 'lon': 120.968, 'tz': 'Asia/Manila'},
    371: {'name': 'Legaspi', 'lat': 13.145, 'lon': 123.758, 'tz': 'Asia/Manila'},
    372: {'name': 'Davao', 'lat': 7.083, 'lon': 125.633, 'tz': 'Asia/Manila'},
    373: {'name': 'Jolo', 'lat': 6.067, 'lon': 121.0, 'tz': 'Asia/Manila'},
    379: {'name': 'Cebu', 'lat': 10.300, 'lon': 123.917, 'tz': 'Asia/Manila'},
    380: {'name': 'Puerto Princesa', 'lat': 9.745, 'lon': 118.736, 'tz': 'Asia/Manila'},
    382: {'name': 'Subic Bay', 'lat': 14.765, 'lon': 120.252, 'tz': 'Asia/Manila'},
    654: {'name': 'Currimao', 'lat': 17.988, 'lon': 120.488, 'tz': 'Asia/Manila'},
    655: {'name': 'Lubang', 'lat': 13.818, 'lon': 120.202, 'tz': 'Asia/Manila'},
}
...
def main():
    ...
    print("=" * 70)
    print("UTide Harmonic Analysis -- Philippines (UHSLC)")
    print("=" * 70)
    ...
    for uhslc_id, meta in sorted(STATIONS.items()):
        ...
        if result:
            ...
            print(f"  R²={result['r_squared']:.4f}, M2={result['m2_amp']:.4f}m, "
                  f"K1={result['k1_amp']:.4f}m, {result['n_analyzed']} Konstituenten")
        print()
    ...
    for r in results:
        m = r['station_meta']
        print(f"  {m['name']:25s}  R²={r['r_squared']:.4f}  "
