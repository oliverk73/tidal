#!/usr/bin/env python3
"""
UTide harmonic analysis for Egyptian UHSLC stations.
Only Alexandria (807) on the Mediterranean. Small tidal range (~10 cm).
"""
import sys
...
CSV_DIR = Path("/home/oliver/water_levels/Egypt_UHSLC")
TEMPLATE_PATH = Path("/home/oliver/harmonics/classic/harmonics-dwf-20070318_mod.txt")
OUTPUT_PATH = Path("/home/oliver/harmonics/utide/harmonics_utide_egypt.txt")
CHECKPOINT_DIR = Path("/home/oliver/harmonics/utide/checkpoints_egypt")

USE_LAST_N_YEARS = 19

STATIONS = {
    807: {'name': 'Alexandria', 'lat': 31.212, 'lon': 29.923, 'country': 'Egypt', 'tz': 'Africa/Cairo', 'gloss_id': None, 'years_to_use': USE_LAST_N_YEARS, 'source': 'UHSLC'},
}
...
def main():
    ...
    print("=" * 70)
    print("UTide - UHSLC Egypt (Alexandria)")
    print("=" * 70)
