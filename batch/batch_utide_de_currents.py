#!/usr/bin/env python3
"""UTide harmonic analysis for German CMEMS in-situ current stations.

Sources: BSH/MARNET buoys, Benthic nodes, historical lightships.
Data: CMEMS INSITU_NWS_PHYBGCWAV_DISCRETE_MYNRT_013_036.
"""
...
CSV_DIR       = Path('/home/oliver/currents/Germany')
META_PATH     = CSV_DIR / '_stations.json'
TEMPLATE_PATH = Path('/home/oliver/harmonics/utide/harmonics_utide_canada_all.txt')
OUTPUT_PATH   = Path('/home/oliver/harmonics/utide/harmonics_utide_germany_currents.txt')
CHECKPOINT    = Path('/home/oliver/harmonics/utide/checkpoints_de_currents')
...
SOURCE_INFO = {
    '6600024': 'BSH MARNET Darßer Schwelle ADCP',
    '6600023': 'BSH MARNET Fehmarn Belt buoy',
    '6200087': 'BSH MARNET NSBIII buoy',
    'N10WBenthicNode': 'BSH/MARNET N10W Benthic Node ADCP',
    'N9NBenthicNode': 'BSH/MARNET N9N Benthic Node ADCP',
    'N7SBenthicNode': 'BSH/MARNET N7S Benthic Node ADCP',
    'LightshipElbe1': 'Historical lightship Elbe 1 (1924-1988)',
    'LightshipElbe4': 'Historical lightship Elbe 4 (1924-1944)',
    'LightshipBremen': 'Historical lightship Bremen (1924-1944)',
    'LightshipFehmarnbelt': 'Historical lightship Fehmarnbelt (1924-1984)',
    'LightshipFlensburg': 'Historical lightship Flensburg (1936-1963)',
    'LightshipKiel2': 'Historical lightship Kiel 2 (1936-1945)',
    'LightshipKiel3': 'Historical lightship Kiel 3 (1947-1967)',
}
...
def fmt_block(r):
    name = r['name']
    src = SOURCE_INFO.get(r['code'], 'CMEMS in-situ')
    L = []
    L.append(f"# Harmonic constants derived from {src}")
    ...
    L.append(f"#")
    L.append(f"# {name}, Germany Current")
    L.append(f"# BEGIN HOT COMMENTS")
    L.append(f"# country: Germany")
    L.append(f"# source: CMEMS in-situ ({src}), UTide analysis")
...
def main():
    ...
    print(f"Deutschland Strömungen — {len(csvs)} CSVs\n")
