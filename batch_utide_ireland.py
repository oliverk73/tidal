#!/usr/bin/env python3
"""
UTide harmonic analysis for Irish tide stations using Marine Institute ERDDAP data.
5-min observations, LAT datum. Checkpoint/resume per station.
"""
import sys
...
NPZ_DIR = Path("/home/oliver/water_levels/Ireland_MI/npz")
TEMPLATE_PATH = Path("/home/oliver/harmonics_working/harmonics-dwf-20070318_no_us_no_dupes.txt")
OUTPUT_PATH = Path("/home/oliver/harmonics_working/harmonics_utide_ireland.txt")
CHECKPOINT_DIR = Path("/home/oliver/harmonics_working/checkpoints_ie")
...
def format_station_block(result):
    ...
    lines = []
    lines.append(f"# Harmonic constants derived from Marine Institute Ireland 5-min observation data")
    ...
    lines.append(f"# country: Ireland")
    lines.append(f"# source: Derived from Marine Institute Ireland observed data with UTide harmonic analysis")
    lines.append(f"# station_id_context: MI-{station['station_id']}")
    ...
    lines.append(f"+01:00 :Europe/Dublin")
...
def main():
    ...
    print("=" * 70)
    print("UTide Harmonic Analysis — Ireland (Marine Institute)")
    print(f"5-min Beobachtungen, LAT-Datum, letzte {USE_LAST_N_YEARS} Jahre")
    print("=" * 70)
