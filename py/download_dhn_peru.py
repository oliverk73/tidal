...
Speichert nach ~/annual_predictions/peru/<YYYY-MM>/Tabla de mareas <hafen>.pdf,
...
Cron (2. jedes Monats, nachdem der Server umgestellt hat):
  0 7 2 * * /usr/bin/python3 /home/oliver/py/download_dhn_peru.py \
      >> /home/oliver/annual_predictions/peru/download.log 2>&1
"""
...
OUTROOT = os.path.expanduser("~/annual_predictions/peru")
