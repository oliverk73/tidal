#!/usr/bin/env python3
"""
Download WLP (Water Level Predictions) from CHS IWLS API for Newfoundland and Labrador stations.
...
OUTPUT_DIR = '/home/oliver/water_levels/Canada_IWLS_NL'
CATALOG_PATH = os.path.join(OUTPUT_DIR, '_nl_stations.json')
...
def download_wlp(station):
    ...
    for m_start, m_end in months:
        ...
        # Fast skip: if first 2 months have no data, this station has no WLP
...
def main():
    ...
    print(f"Downloading WLP for {len(stations)} Newfoundland and Labrador stations")
