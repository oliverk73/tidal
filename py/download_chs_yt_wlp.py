#!/usr/bin/env python3
"""Download WLP from CHS IWLS API for Yukon stations."""
import os, json, time, datetime, sys, requests
import pandas as pd

API_BASE = 'https://api-sine.dfo-mpo.gc.ca/api/v1'
OUTPUT_DIR = '/home/oliver/water_levels/Canada_IWLS_YT'
CATALOG_PATH = os.path.join(OUTPUT_DIR, '_yt_stations.json')
RESOLUTION = 'FIFTEEN_MINUTES'
START_DATE = '2025-01-01'
END_DATE = '2025-12-31'

YT_CODES_JSON = '/tmp/yt_codes.json'
