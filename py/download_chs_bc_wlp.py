#!/usr/bin/env python3
"""
Download WLP (Water Level Predictions) from CHS IWLS API for British Columbia stations.
...
OUTPUT_DIR = '/home/oliver/water_levels/Canada_IWLS_BC'
CATALOG_PATH = os.path.join(OUTPUT_DIR, '_bc_stations.json')
...
def main():
    ...
    print(f"Downloading WLP for {len(stations)} British Columbia stations")
