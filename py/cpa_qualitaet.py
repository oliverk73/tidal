#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Misst Datensaetze gegen die Tafeln der Chittagong Port Authority.

Acht Stationen am Karnaphuli und vor der Kueste, voller Jahrgang 2026.
Verglichen wird der Juli.

Die Prozentzahlen sind hier anders zu lesen als sonst: der Karnaphuli
ist ein Tidefluss, und selbst die aus diesen Tafeln gefitteten Saetze
treffen sie nur auf 2.4 bis 4.3 Prozent des Hubs. Ein Satz mit 3 Prozent
ist dort kein Mangel, sondern das Erreichbare.

Usage: python3 py/cpa_qualitaet.py [--km 3] > harmonics/help/cpa_qualitaet.csv
"""
...
import cpa_referenz as P                                      # noqa: E402
...
def main(argv):
    ...
    liste = P.stationen()
    print(f'{len(liste)} CPA-Stationen, Umkreis {umkreis:.0f} km', file=sys.stderr)
