...
SOURCE_GROUPS = OrderedDict([
    ...
    ('UTide TC',        {'color': '#F44336', 'files': [
                            ...
                            'harmonics_utide_morocco_shom.tcd',
                            'harmonics_utide_tunisia_shom.tcd',
                            'harmonics_utide_france_shom.tcd',
                            'harmonics_utide_spain_shom.tcd',
                            'harmonics_utide_west_africa_shom.tcd',
                            'harmonics_utide_french_guiana_shom.tcd',
                            'harmonics_utide_spm_shom.tcd',
                            'harmonics_utide_taaf_shom.tcd',
                            'harmonics_utide_indian_ocean_fr_shom.tcd',
                            'harmonics_utide_madagascar_shom.tcd',
                            'harmonics_utide_djibouti_shom.tcd',
                            'harmonics_utide_new_caledonia_shom.tcd',
                            'harmonics_utide_wallis_futuna_shom.tcd',
                            'harmonics_utide_french_caribbean_shom.tcd',
                            'harmonics_utide_french_polynesia_shom.tcd',
                            'harmonics_utide_lebanon_shom.tcd',
                            ]}),
