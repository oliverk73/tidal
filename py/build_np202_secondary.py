...
SEC_YEKAT2 = [
    ...
    (1100, 'Guba Sayda', dm(69, 15), dm(33, 15), '+0003', '+0003', 0.0, 0.0, 0.0, 0.0),
    (1102, 'Mys Velikiy', dm(69, 5), dm(33, 17), '+0001', '+0001', 0.0, 0.0, 0.0, 0.0),
    (1103, 'Mys Bazisnyy', dm(69, 1), dm(33, 4), '+0017', '+0017', 0.0, 0.0, 0.0, 0.0),
    (1105, 'Murmansk', dm(68, 58), dm(33, 3), '+0016', '+0005', -0.4, -0.2, 0.1, 0.3, 2.09),
    (1107, 'Guba Korelinskiy', dm(69, 25), dm(33, 25), '-0003', '-0003', 0.0, 0.0, 0.0, 0.0),
    (1108, 'Port Vladimir, Guba Ura', dm(69, 25), dm(33, 9), '+0008', '-0004', -0.5, -0.4, 0.1, 0.3, 2.01),
    (1109, 'Bukhta Nasha', dm(69, 23), dm(32, 55), '-0003', '-0003', 0.0, 0.0, 0.0, 0.0),
