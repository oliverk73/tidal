#!/usr/bin/env python3
"""
Generate Harmonic Constants from UHSLC hourly water level data for Brazil.
...
STATIONS = [
    {'uhslc_id': 716, 'name': 'Santana',              'lat':  -0.067, 'lon': -51.167, 'state': 'Amapa',               'water': 'Atlantic Ocean'},
    {'uhslc_id': 229, 'name': 'Belem',                'lat':  -1.450, 'lon': -48.500, 'state': 'Para',                'water': 'Atlantic Ocean'},
    {'uhslc_id': 715, 'name': 'Madeira',              'lat':  -2.565, 'lon': -44.378, 'state': 'Maranhao',            'water': 'Atlantic Ocean'},
    {'uhslc_id': 711, 'name': 'Luis Correia',         'lat':  -2.867, 'lon': -41.672, 'state': 'Piaui',              'water': 'Atlantic Ocean'},
    {'uhslc_id': 283, 'name': 'Fortaleza',            'lat':  -3.717, 'lon': -38.467, 'state': 'Ceara',              'water': 'Atlantic Ocean'},
    {'uhslc_id': 284, 'name': 'Termisa',              'lat':  -4.817, 'lon': -37.050, 'state': 'Ceara',              'water': 'Atlantic Ocean'},
    {'uhslc_id': 202, 'name': 'Natal',                'lat':  -5.752, 'lon': -35.195, 'state': 'Rio Grande do Norte', 'water': 'Atlantic Ocean'},
    {'uhslc_id': 712, 'name': 'Recife',               'lat':  -8.050, 'lon': -34.867, 'state': 'Pernambuco',         'water': 'Atlantic Ocean'},
    {'uhslc_id': 710, 'name': 'Suape',                'lat':  -8.350, 'lon': -34.950, 'state': 'Pernambuco',         'water': 'Atlantic Ocean'},
    {'uhslc_id': 708, 'name': 'Salvador',             'lat': -12.973, 'lon': -38.517, 'state': 'Bahia',              'water': 'Atlantic Ocean'},
    {'uhslc_id': 707, 'name': 'Canavieiras',          'lat': -15.667, 'lon': -38.967, 'state': 'Bahia',              'water': 'Atlantic Ocean'},
    {'uhslc_id': 201, 'name': 'Peter and Paul Rocks', 'lat':   0.920, 'lon': -29.343, 'state': 'Pernambuco',         'water': 'Atlantic Ocean'},
    {'uhslc_id': 203, 'name': 'Fernando de Noronha',  'lat':  -3.828, 'lon': -32.403, 'state': 'Pernambuco',         'water': 'Atlantic Ocean'},
    {'uhslc_id': 204, 'name': 'Trindade',             'lat': -20.503, 'lon': -29.310, 'state': 'Espirito Santo',     'water': 'Atlantic Ocean'},
    {'uhslc_id': 719, 'name': 'Macae',                'lat': -22.385, 'lon': -41.770, 'state': 'Rio de Janeiro',     'water': 'Atlantic Ocean'},
    {'uhslc_id': 280, 'name': 'Ilha Fiscal',          'lat': -22.897, 'lon': -43.165, 'state': 'Rio de Janeiro',     'water': 'Atlantic Ocean'},
    {'uhslc_id': 282, 'name': 'Ubatuba',              'lat': -23.500, 'lon': -45.117, 'state': 'Sao Paulo',          'water': 'Atlantic Ocean'},
    {'uhslc_id': 281, 'name': 'Cananeia',             'lat': -25.017, 'lon': -47.925, 'state': 'Sao Paulo',          'water': 'Atlantic Ocean'},
    {'uhslc_id': 718, 'name': 'Imbituba',             'lat': -28.230, 'lon': -48.650, 'state': 'Santa Catarina',     'water': 'Atlantic Ocean'},
    {'uhslc_id': 714, 'name': 'Rio Grande',           'lat': -32.138, 'lon': -52.103, 'state': 'Rio Grande do Sul',  'water': 'Atlantic Ocean'},
]
...
def main():
    data_dir = Path('/home/oliver/water_levels/Brazil_UHSLC')
    template_path = Path('/home/oliver/harmonics/utide/harmonics_utide_canada_all.txt')
    output_path = Path('/home/oliver/harmonics/utide/harmonics_utide_brazil.txt')

    print("=" * 70)
    print("Generate Brazil Harmonics with UTide")
    print("=" * 70)
