#!/usr/bin/env python3
"""
Generate Harmonic Constants for Panamanian tide stations using UTide.
Sources: UHSLC (Balboa, Cristobal, El Porvenir) + IOC SLSMF (Bocas del Toro).
...
# ── Station definitions ──────────────────────────────────────────────
UHSLC_STATIONS = [
    {'uhslc_id': 302, 'name': 'Balboa',       'lat': 8.962,  'lon': -79.573, 'water': 'Pacific Ocean'},
    {'uhslc_id': 266, 'name': 'Cristobal',    'lat': 9.350,  'lon': -79.900, 'water': 'Caribbean Sea'},
    {'uhslc_id': 739, 'name': 'El Porvenir',  'lat': 9.558,  'lon': -78.948, 'water': 'Caribbean Sea'},
]

IOC_STATIONS = [
    {'ioc_code': 'bdto', 'name': 'Bocas del Toro', 'lat': 9.3509, 'lon': -82.2577, 'water': 'Caribbean Sea',
...
def main():
    uhslc_dir = Path('/home/oliver/water_levels/Panama_UHSLC')
    ioc_dir = Path('/home/oliver/water_levels/Panama_IOC')
    template_path = Path('/home/oliver/harmonics/utide/harmonics_utide_canada_all.txt')
    output_path = Path('/home/oliver/harmonics/utide/harmonics_utide_panama.txt')

    print("=" * 70)
    print("Generate Panama Harmonics with UTide")
    print("=" * 70)
    ...
    for station in UHSLC_STATIONS:
        ...
        csv_path = uhslc_dir / f'{sid}_panama.csv'
