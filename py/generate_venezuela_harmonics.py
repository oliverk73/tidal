#!/usr/bin/env python3
"""
Generate XTide-compatible harmonic constants for Venezuelan tide stations
from UHSLC Research Quality hourly sea-level data using UTide.

Stations (UHSLC):
  - 247 La Guaira, Venezuela
"""
import numpy as np
...
UHSLC_STATIONS = [
    {'uhslc_id': 247, 'name': 'La Guaira', 'country': 'Venezuela',
     'lat': 10.6170, 'lon': -66.9330, 'water': 'Caribbean Sea',
     'csv': '/home/oliver/water_levels/Venezuela_UHSLC/h247_la_guaira.csv'},
]

# Reuse 175-constituent list from Caribbean generator
...
def main():
    ...
    output_path = Path('/home/oliver/harmonics/utide/harmonics_utide_venezuela.txt')

    print("=" * 70)
    print("Generate Venezuela Harmonics with UTide (UHSLC RQ)")
    print("=" * 70)
