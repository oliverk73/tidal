#!/usr/bin/env python3
"""
Download WLP (Water Level Predictions) from CHS IWLS API for Québec stations.
...
OUTPUT_DIR = '/home/oliver/water_levels/Canada_IWLS_QC'
CATALOG_PATH = os.path.join(OUTPUT_DIR, '_qc_stations.json')
...
def main():
    ...
    print(f"Downloading WLP for {len(stations)} Québec stations")
