#!/usr/bin/env python3
"""
Download WLP (Water Level Predictions) from CHS IWLS API for New Brunswick stations.
...
OUTPUT_DIR = '/home/oliver/water_levels/Canada_IWLS_NB'
CATALOG_PATH = os.path.join(OUTPUT_DIR, '_nb_stations.json')
...
def main():
    ...
    print(f"Downloading WLP for {len(stations)} New Brunswick stations")
